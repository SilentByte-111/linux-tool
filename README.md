...
BASH：
```bash
bash <(curl -fsSL is.gd/Xynrin)
```

FISH：
```bash
curl -fsSL is.gd/Xynrin | sudo bash
```
...
[![Stargazers over time](https://starchart.cc/Xynrin/linux-tool.svg?variant=adaptive)](https://starchart.cc/c-rainstorm/blog)
...
<div align="center">
<img src="./assets/qq1.jpg" alt="qq群头像" width="100" style="border-radius: 50%; object-fit: cover;">
</div>
